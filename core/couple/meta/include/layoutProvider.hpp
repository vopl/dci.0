...
namespace dci { namespace himpl {
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Alias > { static const std::size_t _size=72; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Array > { static const std::size_t _size=64; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Attribute > { static const std::size_t _size=56; static const std::size_t _align=8; static const bool _polymorphic=1; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Enum > { static const std::size_t _size=112; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::EnumValue > { static const std::size_t _size=48; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Iface > { static const std::size_t _size=256; static const std::size_t _align=8; static const bool _polymorphic=1; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::List > { static const std::size_t _size=56; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Map > { static const std::size_t _size=64; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Method > { static const std::size_t _size=88; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Ptr > { static const std::size_t _size=56; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Primitive > { static const std::size_t _size=48; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Scope > { static const std::size_t _size=200; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Set > { static const std::size_t _size=56; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Struct > { static const std::size_t _size=256; static const std::size_t _align=8; static const bool _polymorphic=1; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Scoped > { static const std::size_t _size=8; static const std::size_t _align=8; static const bool _polymorphic=0; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Signed > { static const std::size_t _size=40; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Sign > { static const std::size_t _size=32; static const std::size_t _align=8; static const bool _polymorphic=0; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Variant > { static const std::size_t _size=256; static const std::size_t _align=8; static const bool _polymorphic=1; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Library > { static const std::size_t _size=792; static const std::size_t _align=8; static const bool _polymorphic=0; };
