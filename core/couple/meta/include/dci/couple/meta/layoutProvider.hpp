...
namespace dci { namespace himpl {
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Iface > { static const std::size_t _size=256; static const std::size_t _align=8; static const bool _polymorphic=false; };
