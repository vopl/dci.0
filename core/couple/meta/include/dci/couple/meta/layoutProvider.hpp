...
namespace dci { namespace himpl {
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Alias > { static const std::size_t _size=72; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Attribute > { static const std::size_t _size=56; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Enum > { static const std::size_t _size=88; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::EnumValue > { static const std::size_t _size=80; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Errc > { static const std::size_t _size=88; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::ErrcValue > { static const std::size_t _size=80; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Interface > { static const std::size_t _size=296; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Method > { static const std::size_t _size=104; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Scope > { static const std::size_t _size=224; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Struct > { static const std::size_t _size=280; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Named > { static const std::size_t _size=32; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Variant > { static const std::size_t _size=256; static const std::size_t _align=8; static const bool _polymorphic=false; };
