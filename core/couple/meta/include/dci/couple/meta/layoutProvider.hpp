...
namespace dci { namespace himpl {
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Iface > { static const std::size_t _size=240; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Inheritable< ::dci::couple::meta::Enum> > { static const std::size_t _size=24; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Struct > { static const std::size_t _size=240; static const std::size_t _align=8; static const bool _polymorphic=false; };
    ...
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Variant > { static const std::size_t _size=216; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::Library > { static const std::size_t _size=816; static const std::size_t _align=8; static const bool _polymorphic=false; };
    template <> struct LayoutProvider< ::dci::couple::meta::impl::LibraryBuilder > { static const std::size_t _size=792; static const std::size_t _align=8; static const bool _polymorphic=false; };
}}
