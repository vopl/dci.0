...
namespace dci { namespace himpl {
    ...
    template <> struct LayoutProvider< ::dci::couple::runtime::impl::Sign > { static const std::size_t _size=16; static const std::size_t _align=1; static const bool _polymorphic=0; };
