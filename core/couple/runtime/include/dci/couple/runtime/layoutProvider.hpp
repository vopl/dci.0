...
namespace dci { namespace himpl {
    template <> struct LayoutProvider< ::dci::couple::runtime::impl::Hub > { static const std::size_t _size=0; static const std::size_t _align=1; static const bool _polymorphic=false; };
