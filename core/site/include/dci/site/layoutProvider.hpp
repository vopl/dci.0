...
namespace dci { namespace himpl {
    ...
    template <> struct LayoutProvider< ::dci::site::impl::Manager > { static const std::size_t _size=32; static const std::size_t _align=8; static const bool _polymorphic=0; };
}}
