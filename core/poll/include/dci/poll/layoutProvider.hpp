...
namespace dci { namespace himpl {
    template <> struct LayoutProvider< ::dci::poll::impl::Descriptor > { static const std::size_t _size=88; static const std::size_t _align=8; static const bool _polymorphic=false; };
